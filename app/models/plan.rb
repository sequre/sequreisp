...
class Plan < ActiveRecord::Base
  ...
  def cir_up_real
    @cached_cir_up_real ||= provider_group.cir_total_up * cir_up / provider_group.rate_up
  end

  def cir_down_real
    @cached_cir_down_real ||= provider_group.cir_total_down * cir_down / provider_group.rate_down
  end
